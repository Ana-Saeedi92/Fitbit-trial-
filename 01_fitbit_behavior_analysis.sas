...
ods rtf style=journal file="&out_dir./eating_habits_shift.rtf";
...
ods rtf style=journal file="&out_dir./physical_activity_habits_shift.rtf";
proc freq data=temp_fitbit_wide;
...
ods rtf style=journal file="&out_dir./mindful_habits_shift.rtf";
proc freq data=temp_fitbit_wide;
...
ods rtf style=journal file="&out_dir./sleep_habits_shift.rtf";
proc freq data=temp_fitbit_wide;
...
ods rtf style=journal file="&out_dir./overall_health_shift.rtf";
proc freq data=temp_fitbit_wide;
