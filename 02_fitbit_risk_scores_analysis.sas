/*===========================================================
  Fitbit Risk Scores and Biometrics Analysis
===========================================================*/
options dlcreatedir;
...
/* Expected input datasets in ./data:
   - fhs_risk
   - quest_fv_rand
   - quest_bl_rand
   - fitbit
...
ods rtf style=statistical file="&out_dir./biometric_rerun_11-27-2022.rtf";
...
ods rtf style=journal file="&out_dir./survey_shift.rtf";
proc freq data=temp_fitbit_wide;
  table study_arm*eating_habits_confidence_0*eating_habits_confidence_12
			study_arm*eating_habits_motivation_0*eating_habits_motivation_12
  			study_arm*improve_health_confidence_0*improve_health_confidence_12 
...
ods rtf style=statistical file="&out_dir./fhs_risk_score_model_final.rtf";
 options obs=max;
...
ods rtf style=statistical file="&out_dir./Z-score_model_final.rtf";
...
ods rtf style=statistical file="&out_dir./Z-score_biometric_details.rtf";
...
ods rtf style=statistical file="&out_dir./clinical_risk_levelsl_final.rtf";
...
ods rtf style=statistical file="&out_dir./correlations_baseline.rtf";
...
ods rtf style=statistical file="&out_dir./summary z-scores tests Table 1.rtf";
proc ttest data=temp_zscores plots=none;
  class study_arm;
...
ods rtf style=statistical file="&out_dir./ascvd_risk_score_model_final.rtf";
...
ods rtf style=journal file="&out_dir./correlations_ranked.rtf";
